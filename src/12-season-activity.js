...
export function getSeasonActivity(month, temperature) {
  ...
  if (month<1 || month>12) {
    return null;
     ...
     if (temperature<0) {
      Object.activity="skiing"
     }
     else if (temperature>=0) {
      Object.activity="ice skating"
     ...
     if (temperature>20) {
      Object.activity="hiking"
     }
     else if (temperature<=20) {
      Object.activity="museum visit"
     }
    ...
    if (temperature>35) {
      Object.activity="swimming"
     }
    else  if (temperature<=35) {
      Object.activity="cycling"
     }
  }
  else if (month===9 || month===10 || month ===11) {
   Object.season= "Autumn"
    if (temperature>15) {
      Object.activity="nature walk"
     }
     else if (temperature<=15) {
      Object.activity="reading at a cafe"
     }
  }
